...
app.use(cors({
    origin: ["http://localhost:3000",
        "http://localhost:3001",
        'http://welljanhitchemist.com',
        'http://admin.welljanhitchemist.com',

        'https://welljanhitchemist.com',
        'https://admin.welljanhitchemist.com',
        'https://janhit-chemist.netlify.app',
        'https://janhit-chamist-admin.netlify.app',
        'http://69.62.74.22:3000',
        'http://69.62.74.22:3001'],
